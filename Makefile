...
testDebug: build_debug
	cd ${debug_dir}/Tests ; ./Threads
testDebugGDB: build_debug
	cd ${debug_dir}/Tests ; gdb Threads -ex "handle SIGCONT pass print nostop" -ex "handle SIGSTOP pass print nostop" -ex r --quiet
